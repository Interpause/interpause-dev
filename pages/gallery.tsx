...
export default function Gallery() {
  return (
    <div tw='h-screen text-left'>
      <Head>
        <title>Interpause | Gallery</title>
      ...
      <p>
        TODO:
        <br />
        - This page will contain a bunch of pictures in a fancy CSS grid
        <br />- What will the pictures link to? Where will they come from?
        ¯\_(ツ)_/¯
      </p>
    </div>
  )
